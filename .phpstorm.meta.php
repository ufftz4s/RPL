...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\edukasi-keuangan-backend\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\edukasi-keuangan-backend\\public\\storage',
...
'sanctum.csrf-cookie',
'consultations.index','consultations.store','consultations.show','consultations.update','consultations.destroy',
'financial-records.index','financial-records.store','financial-records.show','financial-records.update','financial-records.destroy','savings-targets.index','savings-targets.store','savings-targets.show','savings-targets.update',
'savings-targets.destroy','storage.local',);
